...
**조문 본문을 못 읽어 `article`을 비운 것 5건** — 긴급복지지원법(본문은
제2조 제9호) · 공동주택관리법 2건(본문은 제63조) · 소방의 화재조사에 관한
법률(investigation-report-wait은 본문에 조문이 없다) · 화재로 인한 재해보상과
보험가입에 관한 법률(법 전체가 대상). 앞의 셋은 **원문을 열면 채울 수 있다.**
